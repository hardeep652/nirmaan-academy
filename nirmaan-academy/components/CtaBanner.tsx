      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end">
            <Link href="/admissions" className="px-8 py-3 rounded-lg gradient-orange text-white font-bold hover:shadow-xl transition-shadow inline-block text-center">
              Apply Now
            </Link>
            <Link href="/contact" className="px-8 py-3 rounded-lg border-2 border-white text-white font-bold hover:bg-white hover:text-blue-900 transition-colors inline-block text-center">
              Contact Us
            </Link>
          </div>
        </div>
