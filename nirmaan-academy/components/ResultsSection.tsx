              ...
              >
                <PremiumCard className="relative h-full">
                  ...
                  <div className="absolute top-3 sm:top-4 right-3 sm:right-4 px-2 sm:px-3 py-0.5 sm:py-1 bg-orange-500 text-white text-xs font-bold rounded-full">
                    <AGR>AGR</AGR> {ranker.rank.replace("AGR ", "")}
                  </div>

                  {/* Photo Placeholder */}
                  <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-blue-400 to-orange-400 flex items-center justify-center text-white font-semibold mx-auto mb-4 text-xs sm:text-sm text-center">
                    Photo
                  </div>

                  {/* Name */}
                  <h3 className="text-base sm:text-lg font-bold text-center" style={{ color: "var(--text-dark)" }}>
                    {ranker.name}
                  </h3>
